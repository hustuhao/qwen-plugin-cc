...
- `/qwen:adversarial-review` uses the same review target selection as `/qwen:review`.
- It supports working-tree review, branch review, and `--base <ref>`.
- It does not support `--scope staged` or `--scope unstaged`.
- Unlike `/qwen:review`, it can still take extra focus text after the flags.
...
- After launching the command, tell the user: "Qwen adversarial review started in the background. Check `/qwen:status` for progress."
