...
Use these blocks selectively when composing Qwen or GPT-5.4 prompts.
...
Use when Qwen should act without asking routine questions.
...
Use when Qwen might otherwise guess.
